...
{{ range $host := list "service-server" "internal-ui" "redis-persistent" "redis-volatile" "logstash" "filestore" (print .Values.datastore.clusterName "-master") (print (get (get .Values "log-storage") "clusterName") "-master") }}
